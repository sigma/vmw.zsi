\chapter{Simple CGI ZSI.dispatch}
\paragraph This is an example of a simple web service CGI Script.  The service
returns and expects SOAP arrays.  A sample soap trace is provided.
