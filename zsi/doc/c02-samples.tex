...
\class{Binding} and \class{ServiceProxy}.  Binding should be used in cases 
...
into the \class{Binding} class.  Using a tracefile instructs \module{ZSI} to
...
interacts with the \method{getPerson} operation described above (this assumes
that you have defined the Person class and typecode in a module named 
\module{ComplexTypes} which is present in \code{sys.path}:
