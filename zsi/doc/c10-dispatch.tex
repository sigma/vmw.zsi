...
It is built on the standard Python \module{httplib} module.
...
\begin{methoddesc}{RPC}{url, opname, pyobj, replyclass\optional{, **keywords}}
...
attribute will be used, otherwise \code{replytype} is interpreted as
...
\begin{methoddesc}{\sl{opname}}{args...}
