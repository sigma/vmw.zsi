...
from vmw.ZSI.client import _Binding
from vmw.ZSI.generate import commands,containers
...
class ServiceProxy:
    ...
    def __init__(self, wsdl, url=None, service=None, port=None,
        ...
        vmw.ZSI.client._Binding constructor.
    ...
    def _load_schema(self, location, xml=None):
        ...
        if (cp is not None and cp.has_section(section) and
            ...
            from vmw.ZSI.wstools import XMLSchema
